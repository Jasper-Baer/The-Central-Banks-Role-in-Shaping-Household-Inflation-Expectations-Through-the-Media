...
data = data[48:dim(data)[1],]

data1 = data %>% select(EA19PRINTO01GYSAM,
                        ...
                        German.Relative.Real.Inflation.Expectations.Gap.Stm.Reuter, # mislabeled
...
data1$time = as.Date(strptime(data1$EA19PRINTO01GYSAM, "%Y-%m-%d"))
