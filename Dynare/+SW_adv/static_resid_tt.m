...
T(15) = 1/(1+T(9)*params(20));
T(16) = (1-params(21))*(1-T(9)*params(21))/params(21)/(1+(params(17)-1)*params(3));
T(17) = T(9)/(1+T(9));
T(18) = 1/(1+(params(23)-1)*params(1))*(1-params(19))*(1-T(9)*params(19))/((1+T(9))*params(19));
