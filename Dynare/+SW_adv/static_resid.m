...
if T_flag
    T = SW_adv.static_resid_tt(T, y, x, params);
end
residual = zeros(45, 1);
lhs = y(32);
...
residual(11) = lhs - rhs;
lhs = y(43);
rhs = params(42)+y(43)*params(43)+y(45);
residual(12) = lhs - rhs;
lhs = y(41);
rhs = params(40)*y(29)+(1-params(40))*((1-params(41))*(y(43)+y(29))+y(29)*params(41));
residual(13) = lhs - rhs;
lhs = y(42);
rhs = y(41)-y(29);
residual(14) = lhs - rhs;
...
residual(19) = lhs - rhs;
lhs = y(24);
rhs = y(33)*1/T(14)+y(41)-y(31)+(T(4)-(1-params(12)))/T(4)*y(22)+(1-params(12))/T(4)*y(24);
residual(20) = lhs - rhs;
lhs = y(25);
rhs = y(33)+T(13)/(1+T(13))*y(25)+1/(1+T(13))*y(25)-T(14)*(y(31)-y(41));
residual(21) = lhs - rhs;
lhs = y(27);
...
residual(23) = lhs - rhs;
lhs = y(29);
rhs = y(37)+T(15)*(y(29)*params(20)+T(9)*y(41)+y(20)*T(16));
residual(24) = lhs - rhs;
lhs = y(30);
rhs = y(38)+T(10)*y(30)+y(30)*T(17)+y(29)*params(18)/(1+T(9))-y(29)*(1+T(9)*params(18))/(1+T(9))+y(41)*T(17)+(params(22)*y(28)+1/(1-T(13))*y(25)-T(13)/(1-T(13))*y(25)-y(30))*T(18);
residual(25) = lhs - rhs;
lhs = y(31);
