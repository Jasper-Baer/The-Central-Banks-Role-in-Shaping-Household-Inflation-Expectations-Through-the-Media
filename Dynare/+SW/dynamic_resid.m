...
if T_flag
    T = SW.dynamic_resid_tt(T, y, x, params, steady_state, it_);
end
residual = zeros(41, 1);
lhs = y(61);
rhs = 1;
...
residual(5) = lhs - rhs;
lhs = y(35);
rhs = y(55)+T(15)*(y(33)*1/T(5)+y(4)+y(65)*T(14));
residual(6) = lhs - rhs;
lhs = y(33);
rhs = y(53)*1/T(7)-y(39)+y(62)*(T(11)-(1-params(12)))/T(11)+y(63)*(1-params(12))/T(11);
residual(7) = lhs - rhs;
lhs = y(34);
rhs = y(53)+y(3)*T(6)/(1+T(6))+y(64)*1/(1+T(6))+(y(37)-y(66))*T(16)-y(39)*T(7);
residual(8) = lhs - rhs;
lhs = y(36);
...
residual(16) = lhs - rhs;
lhs = y(46);
rhs = y(55)+T(15)*(y(44)*1/T(5)+y(7)+y(70)*T(14));
residual(17) = lhs - rhs;
lhs = y(44);
rhs = y(72)-y(51)+y(53)*1/T(7)+y(67)*(T(11)-(1-params(12)))/T(11)+y(68)*(1-params(12))/T(11);
residual(18) = lhs - rhs;
lhs = y(45);
rhs = y(53)+y(6)*T(6)/(1+T(6))+y(69)*1/(1+T(6))+(y(48)-y(71))*T(16)-(y(51)-y(72))*T(7);
residual(19) = lhs - rhs;
lhs = y(47);
...
residual(21) = lhs - rhs;
lhs = y(49);
rhs = y(57)+T(17)*(params(20)*y(9)+y(72)*T(14)+y(40)*T(18));
residual(22) = lhs - rhs;
lhs = y(50);
rhs = y(58)+y(10)*T(15)+y(73)*T(14)/(1+T(14))+y(9)*params(18)/(1+T(14))-y(49)*(1+params(18)*T(14))/(1+T(14))+y(72)*T(14)/(1+T(14))+(params(22)*y(48)+y(45)*T(8)-y(6)*T(9)-y(50))*T(19);
residual(23) = lhs - rhs;
lhs = y(51);
