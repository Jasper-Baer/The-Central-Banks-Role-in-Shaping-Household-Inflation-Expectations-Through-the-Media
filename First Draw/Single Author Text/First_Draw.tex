...
I extend the Bayesian learning model for inflation expectation by \cite{LamlaLein2014} by explicitly adding a channel for central bank communication to the media signal. I assume that the central bank sends a noisy signal for the future inflation $\pi_{t+1}$. 
...
\begin{equation}
s_{\nu,t} = (1-\lambda_{t}) s^b_{\nu,t} + \lambda_{t} c_t \quad 0\leq \lambda_{t} \leq 1
\end{equation}
...
\\
$B_t$ is the difference between the professional inflation forecast and the household inflation expectations and $|B_t|$ is the absolute difference. %I assume that the rational inflation forecasts of the central bank and of the media are similar, i.e, $\Theta_t \approx \Psi_t$.
\begin{equation}
