...
\begin{subfigure}{6cm}
    ...
    \label{100}
\end{subfigure}
\caption{Media Reporting and Inflation: Figure (a) depicts the monthly HICP growth for Germany in red and the media coverage in blue. Media coverage is defined as the number of inflation-related sentences divided by the total number of sentences to account for the varying number of articles in each year. Figure (b) depicts the monthly HICP growth for Germany in red and the INI in blue.}
