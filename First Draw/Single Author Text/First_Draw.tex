...
I assume that $\alpha_t$ and $\lambda_t$ both follow an AR(1) process with
\begin{equation}
\lambda_t = a_{\lambda} + \beta_{\lambda}*\lambda_{t-1} + \epsilon_{\lambda} \quad \epsilon_{\lambda} \sim N(0, \sigma_{\lambda})
\end{equation}
\begin{equation}
