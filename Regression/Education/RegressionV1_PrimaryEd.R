...
fit_no_controls_quotes <- lm(German.Inflation.Balanced.Primary.difference ~
...
fit_no_controls_non_quotes <- lm(German.Inflation.Balanced.Primary.difference ~
            + German.Inflation.Balanced.Primary.difference.Lag1
            + German.Inflation.Balanced.Primary.difference.Lag2
            + German.Inflation.Balanced.Primary.difference.Lag3
...
fit_no_controls_both <- lm(German.Inflation.Balanced.Primary ~
...
fit_no_controls_quotes_count <- lm(German.Inflation.Balanced.Primary.difference ~
              + German.Inflation.Balanced.Primary.difference.Lag1
            + German.Inflation.Balanced.Primary.difference.Lag2
            + German.Inflation.Balanced.Primary.difference.Lag3
...
fit_all_controls_quotes <- lm(German.Inflation.Balanced.Primary.difference ~
            + German.Inflation.Balanced.Primary.difference.Lag1
            + German.Inflation.Balanced.Primary.difference.Lag2
            + German.Inflation.Balanced.Primary.difference.Lag3
...
fit_all_controls_quotes_count <- lm(German.Inflation.Balanced.Primary.difference ~
            + German.Inflation.Balanced.Primary.difference.Lag1
            + German.Inflation.Balanced.Primary.difference.Lag2
            + German.Inflation.Balanced.Primary.difference.Lag3
