...
fit_no_controls_quotes <- lm(German.Inflation.Balanced.Further ~
                             + German.Inflation.Balanced.Further.Lag1
                             + German.Inflation.Balanced.Further.Lag2
                             + German.Inflation.Balanced.Further.Lag3
...
fit_no_controls_non_quotes <- lm(German.Inflation.Balanced.Further ~
                                 + German.Inflation.Balanced.Further.Lag1
                                 + German.Inflation.Balanced.Further.Lag2
                                 + German.Inflation.Balanced.Further.Lag3
...
fit_no_controls_both <- lm(German.Inflation.Balanced.Further ~
                           + German.Inflation.Balanced.Further.Lag1
                           + German.Inflation.Balanced.Further.Lag2
                           + German.Inflation.Balanced.Further.Lag3
...
fit_no_controls_quotes_count <- lm(German.Inflation.Balanced.Further ~
                                   + German.Inflation.Balanced.Further.Lag1
                                   + German.Inflation.Balanced.Further.Lag2
                                   + German.Inflation.Balanced.Further.Lag3
...
fit_all_controls_quotes <- lm(German.Inflation.Balanced.Further ~
                              + German.Inflation.Balanced.Further.Lag1
                              + German.Inflation.Balanced.Further.Lag2
                              + German.Inflation.Balanced.Further.Lag3
...
fit_all_controls_quotes_count <- lm(German.Inflation.Balanced.Further ~
                                    + German.Inflation.Balanced.Further.Lag1
                                    + German.Inflation.Balanced.Further.Lag2
                                    + German.Inflation.Balanced.Further.Lag3
...
var_lab <- c(
  "German.Inflation.Balanced.Further.Lag1" = "$y_{t-1}$",
  "German.Inflation.Balanced.Further.Lag2" = "$y_{t-2}$",
  "German.Inflation.Balanced.Further.Lag3" = "$y_{t-3}$",
  ...
  "Reuter.Poll.Forecast"          = "$\\Delta$ Prof. Inflation Forecast",
