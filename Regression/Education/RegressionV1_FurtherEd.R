...
# household with further education using the news-indicator residuals 
#####################################################################################
...
# Do not scale dummy-type regressors
dont_scale <- c("draghi", "lagarde", "negative", "trichet", "whatever", "Unmon")
